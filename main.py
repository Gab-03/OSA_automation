...
store_master = pd.read_excel("OSA Working file_Template for Automation.xlsx", sheet_name='Store Master')
...
EAN = pd.read_excel("OSA Working file_Template for Automation.xlsx", sheet_name='EAN per Store Type')
